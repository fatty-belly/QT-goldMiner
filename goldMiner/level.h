...
public:
    explicit Level(QWidget *parent = nullptr, int levelNum_ = 1, QString bgm_url_ = "/Users/zhaohaonan/Desktop/北大资料/Coding/C++/程序设计实习/QT-goldMiner/goldMiner/Music/bgm.wav");//levelNum代表第几关
    ~Level();
