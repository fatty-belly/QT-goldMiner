    ...
    addCoin(addCoin_)
{
    ...
    if(!win)
    {
        endPlayer->setSource(QUrl::fromLocalFile("../goldMiner/Music/lose.wav"));
        endPlayer->setLoopCount(1);
        endPlayer->play();
    ...
    {
        endPlayer->setSource(QUrl::fromLocalFile("../goldMiner/Music/win.wav"));
        endPlayer->setLoopCount(1);
        endPlayer->play();
        if(levelNum < Level::totalLevelNum)
        {
